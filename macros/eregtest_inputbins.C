...
void eregtest(
    ...
    SingleVarPlot( hdataclone, meanvar, 0.8, 2.0, 100, "mean" );
    SingleVarPlot( hdataclone, widthvar, 0.0, 0.05, 100, "width" );
    ...
    TCanvas *cptvar = new TCanvas;
    RooPlot *plotptvar = ptvar->frame(-2.,50.,200);
    hdataclone->plotOn(plotptvar);
    plotptvar->Draw();      
    cptvar->SaveAs("ptvar.eps");  
    cptvar->SaveAs("ptvar.png");  
    ...
    Double_t plotECMin(0.0), plotECMax(1.1);
    ...
    gPad->SetGridx();
    gPad->SetGridy();
    TH2* histo2_ecor_ptvar = hdataclone->createHistogram(*ptvar,*ecorvar);   
    TProfile *hprof_ecor_ptvar = histo2_ecor_ptvar->ProfileX();
    hprof_ecor_ptvar->SetErrorOption("s");
    hprof_ecor_ptvar->GetYaxis()->SetRangeUser(plotECMin,plotECMax);
    hprof_ecor_ptvar->GetXaxis()->SetTitle("pt");
    hprof_ecor_ptvar->GetYaxis()->SetTitle("ecor");
    hprof_ecor_ptvar->Draw();
    ...
    canvas_ecor->SaveAs( "corrected_energy.png" );
    ...
    hprof_rawvar_sceta->GetYaxis()->SetRangeUser(plotECMin,plotECMax);
    ...
    hprof_rawvar_r9->GetYaxis()->SetRangeUser(plotECMin,plotECMax);
    ...
    // hprof_rawvar_scphi->GetYaxis()->SetRangeUser(plotECMin,plotECMax);
    ...
    gPad->SetGridx();
    gPad->SetGridy();
    TH2* histo2_rawvar_ptvar = hdataclone->createHistogram(*ptvar,*rawvar);   
    TProfile *hprof_rawvar_ptvar = histo2_rawvar_ptvar->ProfileX();
    hprof_rawvar_ptvar->SetErrorOption("s");
    hprof_rawvar_ptvar->GetYaxis()->SetRangeUser(plotECMin,plotECMax);
    hprof_rawvar_ptvar->GetXaxis()->SetTitle("pt");
    hprof_rawvar_ptvar->GetYaxis()->SetTitle("rawvar");
    hprof_rawvar_ptvar->Draw();
    ...
    // Same thing, now for mean

    Double_t plotMeanMin(0.0), plotMeanMax(2.0);

    meanvar->setRange(0.,2.);
    meanvar->setBins(800);


    TCanvas *canvas_meanvar = new TCanvas("mean_binned","meanvar",canvas_width,canvas_height);
    canvas_meanvar->Divide(2,2);
    ...
    gPad->SetGridx();
    gPad->SetGridy();
    TH2* histo2_meanvar_sceta = hdataclone->createHistogram(*scetavar,*meanvar);    
    TProfile *hprof_meanvar_sceta = histo2_meanvar_sceta->ProfileX();
    hprof_meanvar_sceta->SetErrorOption("s");
    hprof_meanvar_sceta->GetYaxis()->SetRangeUser(plotMeanMin,plotMeanMax);
    hprof_meanvar_sceta->GetXaxis()->SetTitle("eta");
    hprof_meanvar_sceta->GetYaxis()->SetTitle("meanvar");
    hprof_meanvar_sceta->Draw();
    ...
    gPad->SetGridx();
    gPad->SetGridy();
    TH2* histo2_meanvar_r9 = hdataclone->createHistogram(*r9,*meanvar); 
    TProfile *hprof_meanvar_r9 = histo2_meanvar_r9->ProfileX( "r9profile", 1, -1, "X" );
    hprof_meanvar_r9->SetErrorOption("s");
    hprof_meanvar_r9->GetYaxis()->SetRangeUser(plotMeanMin,plotMeanMax);
    hprof_meanvar_r9->GetXaxis()->SetTitle("R9");
    hprof_meanvar_r9->GetYaxis()->SetTitle("meanvar");
    hprof_meanvar_r9->Draw();
    ...
    // gPad->SetGridx();
    // gPad->SetGridy();
    // TH2* histo2_meanvar_scphi = hdataclone->createHistogram(*scphi,*meanvar);   
    // TProfile *hprof_meanvar_scphi = histo2_meanvar_scphi->ProfileX();
    // hprof_meanvar_scphi->SetErrorOption("s");
    // hprof_meanvar_scphi->GetYaxis()->SetRangeUser(plotMeanMin,plotMeanMax);
    // hprof_meanvar_scphi->GetXaxis()->SetTitle("phi");
    // hprof_meanvar_scphi->GetYaxis()->SetTitle("meanvar");
    // hprof_meanvar_scphi->Draw();
   
    canvas_meanvar->cd(3); 
    gPad->SetGridx();
    gPad->SetGridy();
    TH2* histo2_meanvar_ptvar = hdataclone->createHistogram(*ptvar,*meanvar);   
    TProfile *hprof_meanvar_ptvar = histo2_meanvar_ptvar->ProfileX();
    hprof_meanvar_ptvar->SetErrorOption("s");
    hprof_meanvar_ptvar->GetYaxis()->SetRangeUser(plotMeanMin,plotMeanMax);
    hprof_meanvar_ptvar->GetXaxis()->SetTitle("pt");
    hprof_meanvar_ptvar->GetYaxis()->SetTitle("meanvar");
    hprof_meanvar_ptvar->Draw();


    //________________
    //  meanvar_nvtx
    //________________
    //TCanvas *canvas_meanvar_nvtx = new TCanvas("meanvar_nvtx","meanvar_nvtx"); 
    canvas_meanvar->cd(4);
    gPad->SetGridx();
    gPad->SetGridy();
    TH2* histo2_meanvar_nvtx = hdataclone->createHistogram(*nvtx,*meanvar); 
    TProfile *hprof_meanvar_nvtx = histo2_meanvar_nvtx->ProfileX();
    hprof_meanvar_nvtx->SetErrorOption("s");
    hprof_meanvar_nvtx->GetYaxis()->SetRangeUser(plotMeanMin,plotMeanMax);
    hprof_meanvar_nvtx->GetXaxis()->SetTitle("nvtx");
    hprof_meanvar_nvtx->GetYaxis()->SetTitle("meanvar");
    hprof_meanvar_nvtx->Draw();

    canvas_meanvar->SaveAs("meanenergy.png");
